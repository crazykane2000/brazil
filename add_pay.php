            ...
            <div class="row">               
                ...
                <div class="col-xl-6 col-xs-12">
                    <div class="card-box items">
                       <div class="century" style="font-size: 24px;color: #333">Send Brazil Pay request to another Brazil Pay Token address</div>
                          ...
                          <div style="padding: 10px;"></div>
                           ...
                           <form method="POST" action="add_pay_handle.php">
                               
                              <div class="form-group" >
                                <label>Enter Username </label>
                                <input type="text" class="form-control" name="username" id="username"  placeholder="Enter Username of User ">
                             </div>
                             ...
                             <div class="form-group" >
                                <label>No. of Brazil Pay Token To Send <span  style="color: cream;">(You have : <?php echo $pdo_auth['balance']; ?> Brazil Pay Token)</span></label><br/>
                                <input type="number" min="0" class="form-control"  step=".0001" name="token_no"   placeholder="Enter No. of Brazil Pay Token to request">
                             </div>
