   ...
   // Add User Starts Here
     ...
     //$table = "users";  
      ...
      $to .= 'crazykane2000@gmail.com';
       ...
       $subject = 'Brazil Pay: Congratulations, Your Withdraw  is Approved';
	      //// message
	      ...
	      $headers .= 'From: Brazil Pay Withdraw  Approval <no-reply@brazilpay.com>' . "\r\n";
	     ...
	     //echo $actual_link;
	      ...
	      $message = '<!DOCTYPE html>
	        ...
	        <head>
	            ...
	            <title>Success Withdraw  Approval at BrazilPay</title> <!-- The title tag shows in email notifications, like Android 4.4. -->
	        ...
	        <body width="100%" bgcolor="#0087e4" style="margin: 0; mso-line-height-rule: exactly;">
	            <center style="width: 100%; background: #0087e4; text-align: left;">
	                ...
	                <div style="display: none; font-size: 1px; line-height: 1px; max-height: 0px; max-width: 0px; opacity: 0; overflow: hidden; mso-hide: all; font-family: sans-serif;">
	                   Your Withdraw  Request have been Approved, Please Have a look.
	                </div>
	                    ...
	                    <table role="presentation" cellspacing="0" cellpadding="0" border="0" align="center" width="100%" style="max-width: 600px;">
	                        ...
	                        <tr>
	                            <td bgcolor="#ffffff" align="center">
	                                <img src="https://www.nonceblox.com/brazil_pay/administrator/logo.png" width="600" height="" alt="alt_text" border="0" align="center" style="width: 100%; max-width: 600px; height: auto; background: #dddddd; font-family: sans-serif; font-size: 15px; line-height: 140%; color: #555555; margin: auto;" class="g-img">
	                            </td>
	                        </tr>
	                                    ...
	                                    <tr>
	                                        <td style="padding: 40px; font-family: sans-serif; font-size: 15px; line-height: 140%; color: #555555;">
	                                           <p style="margin: 0;">To use conventional banking as an analogy, the blockchain is like a full history of a financial institutions transactions, and each block is like an individual bank statement. But because it is a distributed database system, serving as an open electronic ledger, a blockchain can simplify business operations for all parties.</p>
	                                            ...
	                                            <center><h1 style="margin: 0 0 10px 0; font-family: sans-serif; font-size: 24px; line-height: 125%; color: #0087e4; font-weight: normal;">Congratulations! your Withdraw Request at BrazilPayis Now  Approved </h1></center>
	                                        </td>
	                                    </tr>
	                                    <tr>
	                                        <td style="padding: 0 40px; font-family: sans-serif; font-size: 15px; line-height: 140%; color: #555555;text-align:center">
	                                            <!-- Button : BEGIN -->
	                                             You can Now visit your Dashboard to have a quick look. 
	                                             <br/><br/>
	                                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" align="center" style="margin: auto;">
	                                                <tr>
	                                                    <td style="border-radius: 3px; background: #222222; text-align: center;" class="button-td">
	                                                        ...
	                                                        <a href="'.$actual_link.'/brazil_pay/" style="background: #222222; border: 15px solid #222222; font-family: sans-serif; font-size: 13px; line-height: 110%; text-align: center; text-decoration: none; display: block; border-radius: 3px; font-weight: bold;" target="_blank" class="button-a">
	                                ...
	                                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
	                                    <tr>
	                                        <td style="padding: 40px; text-align: left; font-family: sans-serif; font-size: 12px; line-height: 140%; color: #ffffff;text-align: center;">
	                                            <p style="margin: 0;text-align: center;">Copyrights &copy; 2017-2018, BrazilPay Inc, All Tights Reserved</p>
